...
You will see variances displayed in the outputs of many linear models and we will
discuss how variance, often shown as **_MS_** for "mean sums of square" is used
to test the importance of predictors in another Canva link **add link**.
...
**precision**
* standard error provides a measure of the **accuracy** of you measurement, or
...
What you have just calculated is actually a standard error of the mean (SEM).
You can calculate SE for differences between variables, slopes, intercepts 
...
### An aside in case you a curious
Hopefully you understand that SE simply takes account of the number of 
observations in your sample. Bigger samples are likely to be more accurate,
